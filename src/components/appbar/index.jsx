...
export default function Appbar() {
    return (
      ...
      <div className="flex flex-col md:flex-row md:justify-between">
        <p className="text-blue-700 font-semibold text-lg md:mr-10 mb-4 md:mb-0">Toutes vous Demandes</p>
        <div className="flex flex-col md:flex-row items-center md:ml-10">
          ...
          <button
            className="px-3 py-1 bg-white text-blue-700 rounded-md border border-blue-700 hover:bg-blue-700 hover:text-white text-sm">Search</button>
        </div>
        <div className="flex items-center px-3 ml-0 md:ml-10">
